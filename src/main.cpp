...
const string strMessageMagic = "New Buxcoin Signed Message:\n";
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The times 22.11.2019. New Buxcoin project is here.";
        CTransaction txNew;
        txNew.nTime = 1574447130;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1574447130;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1575805106 : 1575805106 ;
...
printf("block.nNonce = %u \n", block.nNonce);
        ...
        assert(block.hashMerkleRoot == uint256("0x07d5c0b37c2110f79dab5fc41e52cdf5367bbfd2d23beb988d557d7fff0821be"));
